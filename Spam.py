#!/usr/bin/python2
# Author : ./Uchiha-Fahrel(versirdcode:v)
# Team : Uzumaki clan .OFC( BCA - X666X )
...
try:
 ...
 SpamSmsUchihaFahrel   SpamSmsUchihaFahrel
     SpamSmsUchihaFahrel  SpamSmsUchihaFahrel
           SpamSmsUchihaFahrel  SpamSms UchihaFahrel
       SpamSmsUchihaFahrel   SpamSmsUchihaFahrel
    SpamSmsUchihaFahrel SpamSmsUchihaFahrel
      | |                                          
      |_|  '''+W+'Creator : ./Uchiha-Fahrel\n\t\tYT : Gamerxzzz')
